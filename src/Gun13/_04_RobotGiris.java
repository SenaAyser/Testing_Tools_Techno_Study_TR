 ...
 */
      ...
      /*  for(int i=0;i<6;i++) {
        ...
        */
        ...
        StringSelection selection = new StringSelection("C:\\Users\\Kedi^_^\\IdeaProjects\\Techno_Study_Testing_Tools_TR\\src\\Gun13\\_04_RobotGiris");
        ...
        Assert.assertTrue("mesaj gozukmedi",uploadMesaj.getText().contains("has been successfully uploaded.")); // beklentiyi yazıyoruz
